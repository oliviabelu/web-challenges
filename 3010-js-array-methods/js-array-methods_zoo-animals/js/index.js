...
function hasAnimal(animals, animalName) {
  //---short version ---
  //return animals.find((animal) => animal === animalName) ? true : false;
  ...
  //---Bonus---
  // const animalNameLowCase = animalName.toLowerCase();
  // return animals.find((animal) => animal.toLowerCase() === animalNameLowCase)
  //   ? true
  //   : false;

  //---Bonus Version II
  const animalNameLowCase = animalName.toLowerCase();
  const animalsLowCase = animals.map((animal) => animal.toLowerCase());
  return animalsLowCase.find((animal) => animal === animalNameLowCase)
    ? true
    : false;
}
